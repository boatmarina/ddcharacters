import { findClassProgression, generateCustomProgression } from "../data/classFeatures";
...
export default function LevelingGuide({
  ...
  const progression =
    findClassProgression(characterClass) ??
    generateCustomProgression(characterClass, characterFeatures, isSpellcaster, subclass);
